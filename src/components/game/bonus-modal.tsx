  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="animate-in zoom-in-95 relative rounded-2xl border border-pink-500/50 bg-gradient-to-b from-purple-900 to-black p-8 text-center shadow-2xl shadow-pink-500/20">
        ...
        <div className="mt-4 text-3xl font-black text-pink-400">BONUS ROUND!</div>
        <div className="mt-4 space-y-2">
          <div className="text-lg text-white">
            <span className="text-pink-300">{bonus.spinsRemaining}</span> Free Spins
          </div>
          <div className="text-lg text-white">
            <span className="text-yellow-400">{bonus.multiplier}x</span> Multiplier
          </div>
        </div>
        <button
          onClick={onStart}
