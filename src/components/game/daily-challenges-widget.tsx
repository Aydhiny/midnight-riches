...
export function DailyChallengesWidget() {
  ...
  useEffect(() => {
    setIsLoading(true);
    getDailyChallengesProgressAction()
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div className="text-left">
            <div className="text-xs font-bold text-[var(--text-primary)]">{t("dailyChallenges")}</div>
            <div className="text-[10px] text-[var(--text-muted)]">
              {completedCount}/{challenges.length} {t("completed")}
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
                ...
                >
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <div className="shrink-0 text-right">
                      <div className="text-[9px] font-semibold text-amber-500">
                        +{challenge.rewardXp} XP
                      </div>
                      <div className="text-[9px] text-emerald-500">
                        +{challenge.rewardCredits}cr
                      </div>
                    </div>
                  </div>
